<x-app-layout>
    ...
    @endpush
<section class="bg-guru-bg bg-contain bg-right bg-no-repeat  mx-auto px-4 sm:px-6 lg:px-8">

    <div
        class="max-w-8xl my-10 px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 flex gap-3 lg:flex-justify
        lg:flex flex-col lg:flex-row justify-stretch">
        <div class="sm:text-center lg:text-left p-6 justify-self-start bg-zinc-50/90 rounded-lg">
...
<section class="mt-8">
    <p class="text-3xl ">
        Think about it… being asked to write a review has all the appeal of a Friday afternoon homework assignment…
    </p>
</section>
<section class="flex  items-center justify-center gap-24 ">
    ...
    <section>
        <p>Why?</p>
        <p class="m-auto w-[98%] text-center font-semibold italic text-4xl my-8 border-black border-t-2 border-b-2 py-2 ">
            Because writing a review takes way <strong>too much effort</strong> for no real reward.
        </p>
    </section>
    <!-- Accordion Feature Section -->
    <section class="bg-gray-100 py-12 px-6" x-data="{ selected: null }">
